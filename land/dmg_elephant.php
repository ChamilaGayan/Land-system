...
$gnd=$_POST['gnd'];
$req=$_POST['req'];
$cprices=$_POST['cprices'];
$check_one=$_POST['check_one'];
$check_two=$_POST['check_two'];


  $sqlr=mysqli_query($conn,"INSERT INTO dmg_elephant(applicant_name,addres,nic,contact,ds,gnd,requirement,price,ds_forms,assessment_report) 
  value('$name','$addr','$nic','$tpno','$ds','$gnd','$req','$cprices','$check_one','$check_two')");
$affected = $conn -> affected_rows;


if($affected == 1){
    $sms="ඔබගේ වනඅලි හානි සම්බන්ධ වන්දි ඉල්ලීම් අයදුම්පත්‍රය දිස්ත්‍රික් ලේකම් කාර්‍යාලය වෙත ලැබී ඇත.";
    $phone=$tpno;
    $smsuser;
 ...
 <?php include('includes/header.php');?>
   ...
   ?>
                      ...
                      <option value="">තෝරන්න</option>
											...
											<div class="col-md-6">
                                                    <div class="form-group"><label class="small mb-1" for="duration">හානියේ ස්වාභාවය:</label>

                                                    <select class="form-control" name="req" id="req">
                                                    <option value="">තෝරන්න</option>
                                                        <option value="ජීවිත හානි">ජීවිත හානි</option>
                                                        <option value="නිවාස හා දේපල හානි">නිවාස හා දේපල හානි</option> 
                                                        <option value="ශාරීරික හානි">ශාරීරික හානි</option>  
                                                        </select>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group"><label class="small mb-1" for="duration">වන්දි කමිටුව මගින් නිර්දේශ කරන මුදල(රු.)</label>

                                                    <input required class="form-control" id="cprices" name="cprices" type="text" placeholder="මුදල(රු.)"  />
                                                ...
                                                <div class="col-md-12">
                                                <input type="checkbox" id="check_one" name="check_one" value="ආකෘති පත්‍ර අංක 2 ඇත">
                                                <label for="vehicle1"> ආකෘති පත්‍ර අංක 2</label><br>
                                                </div>

                                                <div class="col-md-12">
                                                <input type="checkbox" id="check_two" name="check_two" value="වනසත්ව අඩවි ආරක්ෂකගේ තක්සේරු වාර්තාව ඇත">
                                                <label for="vehicle1"> වනසත්ව අඩවි ආරක්ෂකගේ තක්සේරු වාර්තාව</label><br>
                                                </div>
											</div>
                                          <hr>
