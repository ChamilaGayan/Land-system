...
$check_three=$_POST['check_three'];
$check_four=$_POST['check_four'];
$check_five=$_POST['check_five'];
$check_six=$_POST['check_six'];

  $sqlr=mysqli_query($conn,"INSERT INTO tree_cut(applicant_name,addres,nic,contact,ds,gnd,requirement,tree,qty,dsno,apdate,certified_deed,replicas,plans,partners_letters,ds_recomm,dis_recomm) 
  value('$name','$addr','$nic','$tpno','$ds','$gnd','$req','$tree','$qty','$dsno','$dte','$check_one','$check_two','$check_three','$check_four','$check_five','$check_six')");
$affected = $conn -> affected_rows;



if($affected == 1){
    $sms= "$tree ගස් $qty ක් හෙලීම සදහා ඔබ විසින් ඉදිරිපත් කරන ලද දැව අයදුම්පත දිස්ත්‍රික් ලේකම් කාර්‍යාලය වෙත ලැබී ඇත.";
    $phone=$tpno;
    $smsuser;
...
<body id="page-top">
 ...
 <?php include('includes/header.php');?>
				...
				<!---->						
                                      ...
                                      <div class="form-row">
												 <div class="col-md-6">
													<div class="form-group"><label class="small mb-1" for="record_room_no">ප්‍රා.ලේ.අංකය :</label>
													<input class="form-control" id="dsno" required type="text" name="dsno" placeholder="ප්‍රා.ලේ.අංකය" />
													</div>
											 	 </div>
												 <div class="col-md-6">
                                                    <div class="form-group"><label class="small mb-1" for="other">දිනය :</label>
													<input required class="form-control" id="dte" name="dte" type="date" />
													</div>
                                                </div>
                                        </div>
   ...
   ?>
                      ...
                      <option value="">තෝරන්න</option>
											...
											<div class="col-md-7">
                                                    <div class="form-group"><label class="small mb-1" for="duration">අවශ්‍යතාවය :</label>
													<input required class="form-control py-4" id="duration" name="req" type="text" placeholder="අවශ්‍යතාවය"  />
													</div>
                                                </div>


											<div class="col-md-3">
                                                    <div class="form-group"><label class="small mb-1" for="date_destroy">ගස් වර්ගය :</label>
													<input required class="form-control py-4" id="date_destroy" name="tree" type="text" placeholder="ගස් වර්ගය"  />
													</div>
                                                </div>
												<div class="col-md-2">
                                                    <div class="form-group"><label class="small mb-1" for="other">සංඛ්‍යාව :</label>
													<input required class="form-control py-4" id="other" name="qty" type="text" placeholder="සංඛ්‍යාව"  />
													</div>
                                                </div>
...
<br><br><br><br>
                                                ...
                                                <div class="col-md-12">
                                                <label class="small mb-1" for="other">ඉඩමේ අයිතිය තහවුරු කිරීමට අවශ්‍ය ලිපි ලේඛන :</label>
                                                </div>


                                                <div class="col-md-4">
                                                <input type="checkbox" id="check_one" name="check_one" value="ඔප්පුවේ සහතික කල පිටපත ඇත">
                                                <label for="vehicle1"> ඔප්පුවේ සහතික කල පිටපත</label><br>
                                                </div>

                                                <div class="col-md-6">
                                                <input type="checkbox" id="check_two" name="check_two" value="පත්ඉරු ඇත">
                                                <label for="vehicle1"> පත්ඉරු(මාස 03ක් තුල ලබාගත්)</label><br>
                                                </div>

                                                <div class="col-md-4">
                                                <input type="checkbox" id="check_three" name="check_three" value="පිඹුරුපත් ඇත">
                                                <label for="vehicle1"> පිඹුරුපත්(ඇත්නම්)</label><br>
                                                </div>

                                                <div class="col-md-6">
                                                <input type="checkbox" id="check_four" name="check_four" value="හවුල්කරුවන්ගේ කැමැත්ත ප්‍රකාශිත ලිපි ඇත">
                                                <label for="vehicle1"> හවුල්කරුවන්ගේ කැමැත්ත ප්‍රකාශිත ලිපි</label><br>
                                                </div>

                                                <div class="col-md-4">
                                                <input type="checkbox" id="check_five" name="check_five" value="ප්‍රා.ලේ.නිර්දේශය ඇත">
                                                <label for="vehicle1">ප්‍රා.ලේ.නිර්දේශය</label><br>
                                                </div>

                                                <div class="col-md-6">
                                                <input type="checkbox" id="check_six" name="check_six" value="දි.ලේ.කාර්යාලයෙන් සිදුකල ක්ෂේත්‍ර වාර්තාව ඇත">
                                                <label for="vehicle1">දි.ලේ.කාර්යාලයෙන් සිදුකල ක්ෂේත්‍ර වාර්තාව</label><br>
                                                </div>
